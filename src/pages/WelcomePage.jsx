            ...
            <>
              ...
              <div style={{ background: S.card, border: `1px solid ${S.border}`, borderRadius: 14, padding: '24px 20px', textAlign: 'left' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  {resendState === 'sent' && (
                    <div style={{ background: '#0a1c0e', border: `1px solid ${S.green}`, borderRadius: 8, padding: '10px 16px', fontSize: 14, color: S.green }}>
                      ✓ Access link sent — check your inbox (and spam folder).
                    </div>
                  )}
                  {resendState === 'error' && (
                    <div style={{ background: '#2D1010', border: '1px solid #FF5A5A', borderRadius: 8, padding: '10px 16px', fontSize: 14, color: '#FF5A5A' }}>
          ...
          {phase === 'expired' && (
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {resendState === 'error' && (
                  <div style={{ background: '#2D1010', border: '1px solid #FF5A5A', borderRadius: 8, padding: '10px 16px', fontSize: 14, color: '#FF5A5A' }}>
                    Couldn't send that address. Try <Link to="/login" style={{ color: '#FF5A5A' }}>logging in</Link> instead.
                  </div>
                )}
              </div>
            </>

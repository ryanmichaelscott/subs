  ...
  '/terms': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Member Pass — $99/year — All member discounts (15–35% off every service), valid 12 months',
          'Full Pass — $249/year — All member discounts plus 6 included services ($1,525 total value), valid 12 months, transferable as a gift',
  ...
  '/member-agreement': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Member Pass: unlimited discounted bookings; up to 5 concierge service requests per membership year',
          'Full Pass: unlimited discounted bookings plus the 6 included services; each included service may be redeemed once per membership year',
          'Legacy Member+ and Elite memberships purchased before this pricing change retain unlimited service requests',

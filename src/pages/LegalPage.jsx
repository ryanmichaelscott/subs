  ...
  '/terms': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Member — $99/year — Up to 5 service requests per year',
          'Member+ — $179/year — Unlimited service requests, priority access',
          'Elite — $349/year — Unlimited requests, concierge booking, VIP priority',
  ...
  '/member-agreement': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Member: up to 5 service requests per membership year',
          'Member+: unlimited service requests',
          'Elite: unlimited service requests',

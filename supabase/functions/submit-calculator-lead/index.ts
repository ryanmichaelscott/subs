      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#101410;border:1px solid #252A23;border-radius:14px;overflow:hidden;max-width:560px;">
        ...
        <tr><td style="padding:24px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            ...
            ${row('Email', lead.email ? `<a href="mailto:${esc(lead.email)}" style="color:#5DFF8A;text-decoration:none;">${esc(lead.email)}</a>` : '—')}
...
<body style="margin:0;padding:0;background:#0C0F0A;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0C0F0A;">
    <tr><td align="center" style="padding:40px 16px 48px;">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;">

        <tr><td style="padding-bottom:24px;">
          <div style="font-size:20px;font-weight:800;color:#5DFF8A;letter-spacing:0.08em;">SUBS</div>
          <div style="height:1px;background:#252A23;margin-top:14px;"></div>
        </td></tr>

        <tr><td style="padding-bottom:28px;">
          <div style="font-size:12px;font-weight:700;color:#5DFF8A;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:10px;">🎁 Your free gift</div>
          <h1 style="font-size:28px;font-weight:800;color:#F0EEE8;margin:0 0 14px;line-height:1.2;">Here's your checklist, ${name}.</h1>
          <p style="font-size:14px;color:#8A9088;line-height:1.7;margin:0;">
            As promised — <strong style="color:#F0EEE8;">The Utah Homeowner's Annual Maintenance Checklist</strong> is attached.
        ...
        <tr><td style="padding-bottom:28px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#101410;border:1px solid #252A23;border-radius:14px;">
            <tr><td style="padding:24px 28px;">
              <div style="font-size:15px;font-weight:700;color:#F0EEE8;margin-bottom:6px;">📎 Utah Homeowner's Annual Maintenance Checklist</div>
              <div style="font-size:13px;color:#8A9088;line-height:1.6;margin-bottom:18px;">Attached as a PDF — or grab it any time with the button below. Print it, stick it on the fridge, and check tasks off as the seasons turn.</div>
              <a href="${CHECKLIST_URL}" style="display:inline-block;background:#5DFF8A;color:#0C0F0A;font-size:14px;font-weight:800;padding:12px 26px;border-radius:10px;text-decoration:none;">Download the checklist →</a>
            </td></tr>
          </table>
        </td></tr>

        <tr><td style="padding-bottom:32px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#0A1C0E;border:1px solid #1A3A20;border-radius:14px;">
            <tr><td style="padding:24px 28px;">
              <div style="font-size:11px;font-weight:800;color:#5DFF8A;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;">What happens next</div>
              <p style="font-size:13px;color:#8A9088;line-height:1.7;margin:0;">
                Our concierge team will call or text you shortly to confirm your member pricing on the service you picked.
                The average Utah homeowner saves <strong style="color:#5DFF8A;">$1,200–$2,000+/year</strong> on the routine
        ...
        <tr><td>
          <div style="font-size:12px;color:#8A9088;line-height:1.8;">
            Questions? Call or text <span style="color:#F0EEE8;">1-888-454-3019</span> or visit <a href="https://www.subs.app" style="color:#5DFF8A;text-decoration:none;">subs.app</a><br>
